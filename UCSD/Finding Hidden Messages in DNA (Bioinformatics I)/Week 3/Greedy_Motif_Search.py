...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 10 16:25:43 2019
...
def Greedy_Motif_Search(Dna, k, t):
    ...
    best_score = Scoring_Calculation(Profile_Matrix(best_k_mers), best_k_mers)
    for i in range(len(Dna[0]) - k + 1):
        pattern = Dna[0][i:i+k]
        k_mers = []
        k_mers.append(pattern)
        for j in range(1, t):
            pm = Profile_Matrix(k_mers)
            #print(pm)
